...
namespace EjecutarFlujo
{
    public partial class Form1 : Form
    {
        ...
        public void editarCamposTxt( FileInfo fi)
        {
            //string ruc = "";
            string año = "";
            string mes = "";
            ...
            if (fi.Name.Length == 37 && File.Exists( fi.FullName) && fi.Extension.ToLower() == ".txt" && fi.Length > 0)
            {
                ...
                if (true)
                {
                    ...
                    */
                    ...
                    {
                        /*
                        Para el(año 2020 ) o para el año 2021 en adelante en los txt cargados por los usuarios
                            En el libro IB: eliminar campo 5 en  3.7

                        */
                        if (tipo_libro == "0307")
                        {
                            Editar_registros_txt(4, fi.FullName, fi.FullName);
                    ...
                    {
                        /*
                        Para el(año 2020 Y MES desde a julio hasta diciembre) o para el año 2021 en adelante en los txt cargados por los usuarios
                            En el libro kaRDEX: eliminar campo 8                                                                  
                        */
                        if (fi.Name.Substring(21, 2) == "13")
                        {
                            Editar_registros_txt(7, fi.FullName, fi.FullName);
                    ...
                    if (true)
                    {
                        /*
                        Para el(año 2020) o para el año 2021 en adelante en los txt cargados por los usuarios
                            En el libro AF: eliminar campo 6                                                                  
                        */
                        if (tipo_libro == "0701")
                        {
                            Editar_registros_txt(5, fi.FullName, fi.FullName);
        ...
        public void Kardex_adicional()
        {
            ...
            string flujoKardex = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex_Adic\Pry_kardex_2018_21082019_RELAPASAA_v2.str";
            ...
            DirectoryInfo mainfolder = new DirectoryInfo(@"J:\COMMON\Eddy Fernando TAX\PLB_Kardex_Adic");
            ...
            foreach (var folders in mainfolder.GetDirectories())
            {
                ...
                #region Verificar si existe declaracion de archivos a cargar
                if (File.Exists(ubicacion_archivo_entrada + @"/FORMATO_PARA_IDENTIFICAR_L.E_VERSION_ACTUAL_y_ANTIGUA.xlsx"))
                {
                    #region Verificar que el contenido declarado exista en el ruta
                    //Verificar el nombre de la Hoja

                    if (!validarHoja(ubicacion_archivo_entrada + @"/FORMATO_PARA_IDENTIFICAR_L.E_VERSION_ACTUAL_y_ANTIGUA.xlsx", "Lista_de_archivos"))
                    {

                        return;
                    }
                    //Listar archivos declarados en el formato Excel
                    var package = new ExcelPackage(new FileInfo(ubicacion_archivo_entrada + @"/FORMATO_PARA_IDENTIFICAR_L.E_VERSION_ACTUAL_y_ANTIGUA.xlsx"));
                    ...
                    {
                        valor = workSheet.Cells[i, 1].Value.ToString();
                        //Verificar archivos declarados
                        if (!File.Exists(ubicacion_archivo_entrada + @"/" + valor))
                        {
                            //El archivo declarado no se encuentra en la ruta    
                            return;
                        }
                        //Verificar que declararon un fecha 
                        if (workSheet.Cells[i, 2].Value != null)
                        {
                            DateTime temp;
                            if (DateTime.TryParse(workSheet.Cells[i, 2].Value.ToString(), out temp))
                            {
                                //La fecha declarada es valida

                                DateTime d2 = new DateTime(2021, 1, 2);
                                DateTime.TryParse(workSheet.Cells[i, 2].Value.ToString(), out temp);
                                if (temp >= d2)
                                {
                                    //Formato nuevo
                                    string path = ubicacion_archivo_entrada + @"\" + valor;
                                    FileInfo fi = new FileInfo(path);

                                    //considerar en la edicion de campos los Libros electronicos declarados
                                    if (fi.Extension.ToLower().Contains("txt"))
                                    {
                                        editarCamposTxt(fi);
                                    }
                                }
                ...
                {
                    MessageBox.Show("No se encontro el FORMATO_PARA_IDENTIFICAR_L.E_VERSION_ACTUAL_y_ANTIGUA.xlsx", "Mensaje de ayuda", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                #endregion

                #region editar campos en LE segun version de formato
                /*
                foreach (var fi in di.GetFiles())
                {
                    if (fi.Name.Length == 37 && File.Exists(ubicacion_archivo_entrada + fi.Name) && fi.Extension.ToLower() == ".txt" && fi.Length > 0)
                    {
                        ruc = fi.Name.Substring(2, 11);
                        año = fi.Name.Substring(13, 4);
                        mes = fi.Name.Substring(17, 2);
                ...
                foreach (var fi in di.GetFiles())
                {
                    ...
                    if (fi.Name.Length == 37 && File.Exists(ubicacion_archivo_entrada + fi.Name) && fi.Extension.ToLower() == ".txt" && fi.Length > 0)
                    {
                        ...
                        if (fi.Name.Substring(21, 4) == "0501")
                        {
                            ...
                            establecimiento_anexo = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\Establecimiento_anexo.xlsx";
                            ...
                            {
                                establecimiento_anexo = @"J:\COMMON\Eddy Fernando TAX\TXT_PROCESADOS\Establecimiento_" + ruc + "_" + año + ".xlsx";
                            }
                            ...
                            {
                                kardexene = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //febrero
                            ...
                            {
                                kardexfeb = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //marzo
                            ...
                            {
                                kardexmar = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //abril
                            ...
                            {
                                kardexabr = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //mayo
                            ...
                            {
                                kardexmay = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //junio
                            ...
                            {
                                kardexjun = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //julio
                            ...
                            {
                                kardexjul = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //agosto
                            ...
                            {
                                kardexago = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //setiembre
                            ...
                            {
                                kardexset = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //octubre
                            ...
                            {
                                kardexoct = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //noviembre
                            ...
                            {
                                kardexnov = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //diciembre
                            ...
                            {
                                kardexdic = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            #endregion
                            ...
                            {
                                ubicacion_archivo_entrada3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada5 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada6 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada7 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada8 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada9 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada10 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada11 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada12 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada13 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada14 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            #endregion
                            ...
                            {
                                ubicacion_archivo_entrada15 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada16 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada17 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada18 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada19 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada20 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada21 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada22 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada23 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada24 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada25 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada26 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            #endregion
                            ...
                            {
                                ubicacion_archivo_entrada27 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada28 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada29 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada30 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada31 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada32 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada33 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada34 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada35 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada36 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada37 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ...
                            {
                                ubicacion_archivo_entrada38 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            #endregion
        ...
        public void RDJ2020V3()
        {
            ...
            string ruc, año, mes, dia, tipo_libro;
            string ubicacion_archivo_entrada2 = "";
            string ubicacion_txtVacio = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Flujograma_RDJ_20\TXT_VACIOS\";
            ...
            string rutaclemb = "cd " + @"C:\Program Files\IBM\SPSS\Modeler\18.2.1\bin";
            //Paso 2: generar el sript dinamico para ejecutar el flujo modeler cons us archivos fuentes o inputs
            string flujoRDJ2020 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FLUJOGRAMA_PRUEBAS_RDJ_2020_VRS_9_14102020_vf_para_script.str";
            string Pventrada1 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190100140100001111.txt";
            string Pventrada2 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190200140100001111.txt";
            string Pventrada3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190300140100001111.txt";
            string Pventrada4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190400140100001111.txt";
            string Pventrada5 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190500140100001111.txt";
            string Pventrada6 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190600140100001111.txt";
            string Pventrada7 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190700140100001111.txt";
            string Pventrada8 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190800140100001111.txt";
            string Pventrada9 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120190900140100001111.txt";
            string Pventrada10 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120191000140100001111.txt";
            string Pventrada11 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120191100140100001111.txt";
            string Pventrada12 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\V\LE2051418433120191200140100001111.txt";
            string Pcentrada1 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190100080100001111.txt";
            string Pcentrada2 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190200080100001111.txt";
            string Pcentrada3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190300080100001111.txt";
            string Pcentrada4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190400080100001111.txt";
            string Pcentrada5 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190500080100001111.txt";
            string Pcentrada6 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190600080100001111.txt";
            string Pcentrada7 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190700080100001111.txt";
            string Pcentrada8 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190800080100001111.txt";
            string Pcentrada9 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120190900080100001111.txt";
            string Pcentrada10 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120191000080100001111.txt";
            string Pcentrada11 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120191100080100001111.txt";
            string Pcentrada12 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\C\LE2051418433120191200080100001111.txt";
            string Pnodomic1 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190100080200001111.txt";
            string Pnodomic2 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190200080200001111.txt";
            string Pnodomic3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190300080200001111.txt";
            string Pnodomic4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190400080200001111.txt";
            string Pnodomic5 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190500080200001111.txt";
            string Pnodomic6 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190600080200001111.txt";
            string Pnodomic7 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190700080200001111.txt";
            string Pnodomic8 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190800080200001111.txt";
            string Pnodomic9 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120190900080200001111.txt";
            string Pnodomic10 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120191000080200001111.txt";
            string Pnodomic11 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120191100080200001111.txt";
            string Pnodomic12 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\FUENTE\NO_DOMIC\LE2051418433120191200080200001111.txt";
            string Plibromayor1 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Flujograma_RDJ_20\TXT_VACIOS\LE_FORMATO_LIBRO_MAYOR.txt";
            string Pconsolidadordj = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\CONSOLIDADO_RDJ1.html";
            string Pcompra = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\COMPRAS.txt";
            string Pventa = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\VENTAS.txt";
            string PRDJRP_006_2 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJRP_006_2.xlsx";
            string PRDJRP_006 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJRP_006.xlsx";
            string PRDJLM_001_RESUMEN = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\PRDJLM_001_RESUMEN.xlsx";
            string PRDJLM_001_DETALLE = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJLM_001_DETALLE.xlsx";
            string PRDJLM_001_DETALLE_TXT = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJLM_001_DETALLE_TXT.txt";
            string PRDJLM_002 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJLM_002.xlsx";
            string PRDJLM_003 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJLM_003.xlsx";
            string PRDJLM_004 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJLM_004.xlsx";
            string PRDJLM_005 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJLM_005.xlsx";
            string PRDJLM_005_TXT = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\PROYECTO\PROY_RDJ_2020_LM\CLEMB_BATCH\RESUL\RDJLM_005_TXT.txt";
        ...
        public void SIAF()
        {
            ...
            string flujoDepr2020 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Depreciacion_20\DEPRECIACION_v20.str";
        ...
        private bool validarHoja(string rutaLibro, string nombrehoja)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Error: Nombre Hoja '" + hojaName + "' no permitido!", "El nombre de la hoja esperada es: " + nombrehoja);
                    pck.Dispose();
                    return false;
                }
            }
        ...
        public void FlujosLite()
        {
            ...
            string ubicacion_flujo_af = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\AF\AF.str";
            string ubicacion_flujo_kardex = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\Kardex.str";
            string ubicacion_ib = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\IB.str";
            string ubicacion_flujoCosto = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Costo\Prg_Costo_Goldfiled_18_v2_PARA_EJECUTABLE.str";
            ...
            //Costo
            string ubicacion_costo1 = "";
            string ubicacion_costo2 = "";
            string ubicacion_costo3 = "";
            string ubicacion_costo4 = "";
            ...
            foreach (var folders in mainfolder.GetDirectories())
            {
                ...
                foreach (var fi in di.GetFiles())
                {
                    if (fi.Name.Length == 37 && File.Exists(fi.FullName) && fi.Extension == ".txt" && fi.Length > 0)
                    {
                        ...
                        //Compras y Ventas
                        if ((año == "2020" && mes == "12") || (int.Parse(año) > 2020) && fi.Extension == "txt")
                        {
                        ...
                        //IB
                        if ((año == "2020") || (int.Parse(año) > 2020) && fi.Extension == "txt")
                        {
                        ...
                        //Kardex
                        if ((año == "2020" && int.Parse(mes) > 6) || (int.Parse(año) > 2020) && fi.Extension == "txt")
                        {
                ...
                */
                ...
                foreach (var fi in di.GetFiles())
                {
                    ...
                    //http://orientacion.sunat.gob.pe/index.php/empresas-menu/libros-y-registros-vinculados-asuntos-tributarios-empresas/sistema-de-libros-electronicos-ple/6560-05-nomenclatura-de-libros-electronicos
                    //Los nombres de libros electronicos tienen 33 caracteres fi.Name.Length == 37 && File.Exists(ubicacion_archivo_entrada + fi.Name)
                    if (((fi.Name.Length == 37)) && File.Exists(fi.FullName) && fi.Length > 0)
                    {
                        HINICIO = DateTime.Now.ToString();
                        ...
                        */
                        if (fi.Name.Substring(21, 2) == "03")
                        {
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada3))
                            {
                                ubicacion_archivo_entrada3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.1.txt";
                            }
                            //Anexo3_2
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada4))
                            {
                                ubicacion_archivo_entrada4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.2.txt";
                            }
                            //Anexo3_3
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada5))
                            {
                                ubicacion_archivo_entrada5 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.3.txt";
                            }
                            //Anexo3_4
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada6))
                            {
                                ubicacion_archivo_entrada6 = ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "03040001" + fi.Name.Substring(fi.Name.Length - 8, 8);
                                if (!File.Exists(ubicacion_archivo_entrada6))
                                {
                                    ubicacion_archivo_entrada6 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.4.txt";
                                }
                            }
                            /*
                            ubicacion_archivo_entrada6 = ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "03040001" + fi.Name.Substring(fi.Name.Length - 8, 8);
                            ...
                            */
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada7))
                            {
                                ubicacion_archivo_entrada7 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.5.txt";
                            }
                            //Anexo3_6
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada8))
                            {
                                ubicacion_archivo_entrada8 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.6.txt";
                            }
                            //Anexo3_7
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada9))
                            {
                                ubicacion_archivo_entrada9 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.7.txt";
                            }
                            //Anexo3_8
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada10))
                            {
                                ubicacion_archivo_entrada10 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.8.txt";
                            }
                            //Anexo3_9
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada11))
                            {
                                ubicacion_archivo_entrada11 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.9.txt";
                            }
                            //Anexo3_11
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada12))
                            {
                                ubicacion_archivo_entrada12 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.11.txt";
                            }
                            //Anexo3_12
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada13))
                            {
                                ubicacion_archivo_entrada13 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.12.txt";
                            }
                            //Anexo3_13
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada14))
                            {
                                ubicacion_archivo_entrada14 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.13.txt";
                            }
                            //Anexo3_14
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada15))
                            {
                                ubicacion_archivo_entrada15 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.14.txt";
                            }
                            //Anexo3_15
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada16))
                            {
                                ubicacion_archivo_entrada16 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.15.txt";
                            }
                            //Anexo3_16_1
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada17))
                            {
                                ubicacion_archivo_entrada17 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.16.1.txt";
                            }
                            //Anexo3_16_2
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada18))
                            {
                                ubicacion_archivo_entrada18 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.16.2.txt";
                            }
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada19))
                            {
                                ubicacion_archivo_entrada19 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\IB\TXT_VACIOS\3.17.txt";
                            }
                            #endregion
                        ...
                        */
                        if (fi.Name.Substring(21, 4) == "0701")
                        {
                            ...
                            comandos = "clemb -stream " + "\"" + ubicacion_flujo_af + "\"" +
                                " -Pafentrada.full_filename=" + "\"" + ubicacion_archivo_entrada2 + "\"" +
                                " -Pafsalida.full_filename=" + "\"" + ubicacion_archivo_salida2 + "\"" +
                                " -PPERIODO_CUR=" + "\"" + año + "\"" + " -Pconsolidadoaf.full_filename=" + "\"" + consolidado_html2 + "\"" +
                                " -execute -log " + "\"" + ubicacion_archivo_log2 + "\"";
                            //MessageBox.Show(comandos);
                            //txtComandos.Text = comandos;
                            //MessageBox.Show(comandos);
                        ...
                        */
                        ...
                        {
                            ubicacion_costo1 = ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1001" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_costo1))
                            {
                                ubicacion_costo1 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Costo\TXT_VACIOS\Costo_10_1_vacio.txt";
                            }
                            ubicacion_costo2 = ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1002" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_costo2))
                            {
                                ubicacion_costo2 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Costo\TXT_VACIOS\Costo_10_2_vacio.txt";
                            }
                            ubicacion_costo3 = ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1003" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_costo3))
                            {
                                ubicacion_costo3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Costo\TXT_VACIOS\Costo_10_3_vacio.txt";
                            }
                            ubicacion_costo4 = ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1004" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_costo4))
                            {
                                ubicacion_costo4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Costo\TXT_VACIOS\Costo_10_4_vacio.txt";
                            }
                            ubicacion_archivo_entrada19 = @"J:\COMMON\Eddy Fernando TAX\TXT_PROCESADO\";
                            ubicacion_archivo_log2 = ubicacion_archivo_log + "LogCosto_" + folders.Name + "_" + ruc + "_" + "_" + año + "_" + mes + ".txt";
                            comandos = "clemb -stream " + "\"" + ubicacion_flujoCosto + "\"" +
                                " -Pcosto_10_1.full_filename=" + "\"" + ubicacion_costo1 + "\"" +
                                " -Pcosto_10_2.full_filename=" + "\"" + ubicacion_costo2 + "\"" +
                                " -Pcosto_10_3.full_filename=" + "\"" + ubicacion_costo3 + "\"" +
                                " -Pcosto_10_4.full_filename=" + "\"" + ubicacion_costo4 + "\"" +
                                " -Pcostosalida.full_filename=" + "\"" + ubicacion_archivo_salida + folders.Name + @"\Costo_" + ruc + "_" + año + ".txt" + "\"" +
                                " -Pcostoconsolidad.full_filename=" + "\"" + ubicacion_archivo_salida + folders.Name + @"\Consolidado.html" + "\"" +
                                " -execute -log " + "\"" + ubicacion_archivo_log2 + "\"";
                            comandos = rutaclemb + " && " + comandos;
                            ejecutar_flujo_modeler(comandos);
                            if (File.Exists(ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1001" + fi.Name.Substring(fi.Name.Length - 12, 12)))
                                mover_archivo(ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1001" + fi.Name.Substring(fi.Name.Length - 12, 12), fi.Name.Substring(0, 21) + "1001" + fi.Name.Substring(fi.Name.Length - 12, 12));
                            if (File.Exists(ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1002" + fi.Name.Substring(fi.Name.Length - 12, 12)))
                                mover_archivo(ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1002" + fi.Name.Substring(fi.Name.Length - 12, 12), fi.Name.Substring(0, 21) + "1002" + fi.Name.Substring(fi.Name.Length - 12, 12));
                            if (File.Exists(ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1003" + fi.Name.Substring(fi.Name.Length - 12, 12)))
                                mover_archivo(ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1003" + fi.Name.Substring(fi.Name.Length - 12, 12), fi.Name.Substring(0, 21) + "1003" + fi.Name.Substring(fi.Name.Length - 12, 12));
                            if (File.Exists(ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1004" + fi.Name.Substring(fi.Name.Length - 12, 12)))
                                mover_archivo(ubicacion_archivo_entrada + fi.Name.Substring(0, 21) + "1004" + fi.Name.Substring(fi.Name.Length - 12, 12), fi.Name.Substring(0, 21) + "1004" + fi.Name.Substring(fi.Name.Length - 12, 12));
                        ...
                        */
                        if (fi.Name.Substring(21, 4) == "1301")
                        {
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada + "Establecimiento_" + ruc + "_" + año + ".xlsx"))
                            {
                                estableciemitno_anexo = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\Establecimiento_anexo.xlsx";
                            }
                            if (!File.Exists(@"J:\COMMON\Eddy Fernando TAX\TXT_PROCESADOS\Establecimiento_" + ruc + "_" + año + ".xlsx"))
                            {
                                estableciemitno_anexo = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\Establecimiento_anexo.xlsx";
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada3))
                            {
                                ubicacion_archivo_entrada3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //febrero
                            ubicacion_archivo_entrada4 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "02" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada4))
                            {
                                ubicacion_archivo_entrada4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //marzo
                            ubicacion_archivo_entrada5 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "03" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada5))
                            {
                                ubicacion_archivo_entrada5 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //abril
                            ubicacion_archivo_entrada6 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "04" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada6))
                            {
                                ubicacion_archivo_entrada6 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //mayo
                            ubicacion_archivo_entrada7 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "05" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada7))
                            {
                                ubicacion_archivo_entrada7 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //junio
                            ubicacion_archivo_entrada8 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "06" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada8))
                            {
                                ubicacion_archivo_entrada8 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //julio
                            ubicacion_archivo_entrada9 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "07" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada9))
                            {
                                ubicacion_archivo_entrada9 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //agosto
                            ubicacion_archivo_entrada10 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "08" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada10))
                            {
                                ubicacion_archivo_entrada10 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //setiembre
                            ubicacion_archivo_entrada11 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "09" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada11))
                            {
                                ubicacion_archivo_entrada11 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //octubre
                            ubicacion_archivo_entrada12 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "10" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada12))
                            {
                                ubicacion_archivo_entrada12 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //noviembre
                            ubicacion_archivo_entrada13 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "11" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada13))
                            {
                                ubicacion_archivo_entrada13 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            //diciembre
                            ubicacion_archivo_entrada14 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "12" + fi.Name.Substring(fi.Name.Length - 18, 18);
                            if (!File.Exists(ubicacion_archivo_entrada14))
                            {
                                ubicacion_archivo_entrada14 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\Kardex\TXT_VACIOS\kardex_vacio.txt";
                            }
                            #endregion
        ...
        private void CVD1()
        {
            ...
            string ubicacion_flujo_cvd = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_1\CVD.str";
            ...
            foreach (var folders in mainfolder.GetDirectories())
            {
                ...
                #region Editamos campos segun version
                /*
                foreach (var fi in di.GetFiles())
                {
                    if (fi.Name.Length == 37 && File.Exists(ubicacion_archivo_entrada + fi.Name) && fi.Extension.ToLower() == ".txt" && fi.Length > 0)
        ...
        private void CVD2()
        {
            ...
            string ubicacion_flujo_cvd = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\CVD.str";
                ...
                foreach (var fi in di.GetFiles())
                {
                    ...
                    if (fi.Name.Length == 37 && File.Exists(ubicacion_archivo_entrada + fi.Name))
                    {
                        ...
                        if (fi.Name.Substring(21, 4) == "0501")
                        {
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada3))
                            {
                                ubicacion_archivo_entrada3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada4 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "02" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada4))
                            {
                                ubicacion_archivo_entrada4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada5 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "03" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada5))
                            {
                                ubicacion_archivo_entrada5 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada6 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "04" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada6))
                            {
                                ubicacion_archivo_entrada6 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada7 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "05" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada7))
                            {
                                ubicacion_archivo_entrada7 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada8 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "06" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada8))
                            {
                                ubicacion_archivo_entrada8 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada9 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "07" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada9))
                            {
                                ubicacion_archivo_entrada9 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada10 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "08" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada10))
                            {
                                ubicacion_archivo_entrada10 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada11 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "09" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada11))
                            {
                                ubicacion_archivo_entrada11 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada12 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "10" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada12))
                            {
                                ubicacion_archivo_entrada12 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada13 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "11" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada13))
                            {
                                ubicacion_archivo_entrada13 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada14 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "12" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada14))
                            {
                                ubicacion_archivo_entrada14 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            #endregion
                            //detectar si hay txt compras entrada
                            #region Esta seccion detecta los libros de Compras mes a mes (ene-dic) si no esta algun libro lo reemplaza por un formato vacio
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada15))
                            {
                                ubicacion_archivo_entrada15 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada16 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "02" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada16))
                            {
                                ubicacion_archivo_entrada16 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada17 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "03" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada17))
                            {
                                ubicacion_archivo_entrada17 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada18 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "04" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada18))
                            {
                                ubicacion_archivo_entrada18 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada19 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "05" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada19))
                            {
                                ubicacion_archivo_entrada19 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada20 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "06" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada20))
                            {
                                ubicacion_archivo_entrada20 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada21 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "07" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada21))
                            {
                                ubicacion_archivo_entrada21 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada22 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "08" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada22))
                            {
                                ubicacion_archivo_entrada22 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada23 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "09" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada23))
                            {
                                ubicacion_archivo_entrada23 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada24 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "10" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada24))
                            {
                                ubicacion_archivo_entrada24 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }

                            ubicacion_archivo_entrada25 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "11" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada25))
                            {
                                ubicacion_archivo_entrada25 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada26 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "12" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada26))
                            {
                                ubicacion_archivo_entrada26 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            #endregion
                            //detectar si hay txt diario entrada
                            #region Esta seccion detecta los libros Diarios mes a mes (ene-dic) si no esta algun libro lo reemplaza por un formato vacio
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada27))
                            {
                                ubicacion_archivo_entrada27 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada28 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "02" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada28))
                            {
                                ubicacion_archivo_entrada28 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada29 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "03" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada29))
                            {
                                ubicacion_archivo_entrada29 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada30 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "04" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada30))
                            {
                                ubicacion_archivo_entrada30 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada31 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "05" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada31))
                            {
                                ubicacion_archivo_entrada31 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada32 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "06" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada32))
                            {
                                ubicacion_archivo_entrada32 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada33 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "07" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada33))
                            {
                                ubicacion_archivo_entrada33 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada34 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "08" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada34))
                            {
                                ubicacion_archivo_entrada34 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada35 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "09" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada35))
                            {
                                ubicacion_archivo_entrada35 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada36 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "10" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada36))
                            {
                                ubicacion_archivo_entrada36 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada37 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "11" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada37))
                            {
                                ubicacion_archivo_entrada37 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada38 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "12" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada38))
                            {
                                ubicacion_archivo_entrada38 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_2\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            #endregion
        ...
        private void CVD3()
        {
            ...
            string ubicacion_flujo_cvd = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\CVD.str";
                ...
                foreach (var fi in di.GetFiles())
                {
                    ...
                    if (fi.Name.Length == 37 && File.Exists(ubicacion_archivo_entrada + fi.Name))
                    {
                        ...
                        if (fi.Name.Substring(21, 4) == "0501")
                        {
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada3))
                            {
                                ubicacion_archivo_entrada3 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada4 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "02" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada4))
                            {
                                ubicacion_archivo_entrada4 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada5 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "03" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada5))
                            {
                                ubicacion_archivo_entrada5 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada6 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "04" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada6))
                            {
                                ubicacion_archivo_entrada6 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada7 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "05" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada7))
                            {
                                ubicacion_archivo_entrada7 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada8 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "06" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada8))
                            {
                                ubicacion_archivo_entrada8 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada9 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "07" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada9))
                            {
                                ubicacion_archivo_entrada9 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada10 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "08" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada10))
                            {
                                ubicacion_archivo_entrada10 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada11 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "09" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada11))
                            {
                                ubicacion_archivo_entrada11 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada12 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "10" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada12))
                            {
                                ubicacion_archivo_entrada12 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada13 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "11" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada13))
                            {
                                ubicacion_archivo_entrada13 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada14 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "12" + fi.Name.Substring(19, 2) + "1401" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada14))
                            {
                                ubicacion_archivo_entrada14 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_VENTA_VACIO.TXT";
                            }
                            #endregion
                            //detectar si hay txt compras entrada
                            #region Esta seccion detecta los libros de Compras mes a mes (ene-dic) si no esta algun libro lo reemplaza por un formato vacio
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada15))
                            {
                                ubicacion_archivo_entrada15 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada16 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "02" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada16))
                            {
                                ubicacion_archivo_entrada16 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada17 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "03" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada17))
                            {
                                ubicacion_archivo_entrada17 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada18 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "04" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada18))
                            {
                                ubicacion_archivo_entrada18 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada19 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "05" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada19))
                            {
                                ubicacion_archivo_entrada19 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada20 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "06" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada20))
                            {
                                ubicacion_archivo_entrada20 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada21 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "07" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada21))
                            {
                                ubicacion_archivo_entrada21 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada22 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "08" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada22))
                            {
                                ubicacion_archivo_entrada22 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada23 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "09" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada23))
                            {
                                ubicacion_archivo_entrada23 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada24 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "10" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada24))
                            {
                                ubicacion_archivo_entrada24 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }

                            ubicacion_archivo_entrada25 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "11" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada25))
                            {
                                ubicacion_archivo_entrada25 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada26 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "12" + fi.Name.Substring(19, 2) + "0801" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada26))
                            {
                                ubicacion_archivo_entrada26 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_COMPRAS_VACIO.TXT";
                            }
                            #endregion
                            //detectar si hay txt diario entrada
                            #region Esta seccion detecta los libros Diarios mes a mes (ene-dic) si no esta algun libro lo reemplaza por un formato vacio
                            ...
                            if (!File.Exists(ubicacion_archivo_entrada27))
                            {
                                ubicacion_archivo_entrada27 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada28 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "02" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada28))
                            {
                                ubicacion_archivo_entrada28 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada29 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "03" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada29))
                            {
                                ubicacion_archivo_entrada29 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada30 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "04" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada30))
                            {
                                ubicacion_archivo_entrada30 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada31 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "05" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada31))
                            {
                                ubicacion_archivo_entrada31 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada32 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "06" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada32))
                            {
                                ubicacion_archivo_entrada32 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada33 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "07" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada33))
                            {
                                ubicacion_archivo_entrada33 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada34 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "08" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada34))
                            {
                                ubicacion_archivo_entrada34 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada35 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "09" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada35))
                            {
                                ubicacion_archivo_entrada35 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada36 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "10" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada36))
                            {
                                ubicacion_archivo_entrada36 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada37 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "11" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada37))
                            {
                                ubicacion_archivo_entrada37 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            ubicacion_archivo_entrada38 = ubicacion_archivo_entrada + fi.Name.Substring(0, 17) + "12" + fi.Name.Substring(19, 2) + "0501" + fi.Name.Substring(fi.Name.Length - 12, 12);
                            if (!File.Exists(ubicacion_archivo_entrada38))
                            {
                                ubicacion_archivo_entrada38 = @"C:\Users\Luis.Romero.G\OneDrive - EY\Desktop\Flujos_Modeler\CVD_3\TEXT_VACIOS\LE_FORMATO_DIARIO_VACIO.TXT";
                            }
                            #endregion
        ...
        private void Editar_registros_txt(int nro_columna, string ruta_txt, string nueva_ruta_txt)
        {
            ...
            #region nuevo metodo sobreescribir

            File.Delete(ruta_txt);//elimina archivo

            var stopwatch = new Stopwatch();
            stopwatch.Start();

            using (StreamWriter sw1 = File.AppendText(nueva_ruta_txt))//vuelve a crear el archivo con el mismo nombre 
            {
                foreach (string line in lines)
                {
                    var cols = line.Split('|');
